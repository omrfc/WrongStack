...
| **P4-3** | Update `AutoApprovePermissionPolicy` to use capabilities as primary check | 2-3 h | ✅ Fixed (2026-06-13) | `DefaultPermissionPolicy` capability-based destructive gating + auto-approve gate; commit `c71f132a` |
| **P4-4** | Update subagent dangerous-tool guard to allowlist by default | 1-2 h | ✅ Fixed (2026-06-13) | `AutoApprovePermissionPolicy` allowlist-by-default; default allowed: `fs.read`, `net.outbound`; constructor accepts custom allowlist; commit `a61c1acb` |
